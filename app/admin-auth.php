...
function tyaa_render_login(array $config, string $error = ''): never
{
    ...
    echo '<!doctype html><html lang="' . $h($translator->htmlLang()) . '"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
        ...
        . '<div class="brand"><div class="mark">T</div><div><h1>Tenyen Analytics</h1><p>Administration v0.6.2</p></div></div>'
        ...
        . '<p class="hint">Tenyen Analytics v0.6.2 — <a href="https://www.10yendama.com/" target="_blank" rel="noopener noreferrer">Powered by 10yendama.com</a> — © 2026 10yendama.com</p>'
        . '</main></body></html>';
    exit;
}
