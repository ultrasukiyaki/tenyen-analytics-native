...
function tyaav_render(string $view, array $services, array $query): array
{
    ...
    $titles=['dashboard'=>tyaav_t('nav.dashboard'),'realtime'=>tyaav_t('nav.realtime'),'history'=>tyaav_t('nav.history'),'sessions'=>tyaav_t('nav.sessions'),'events'=>tyaav_t('nav.events'),'campaigns'=>tyaav_t('nav.campaigns'),'content'=>tyaav_t('nav.content'),'referrers'=>tyaav_t('nav.referrers'),'organizations'=>tyaav_t('nav.organizations'),'metadata'=>tyaav_t('nav.metadata'),'exclusions'=>tyaav_t('nav.exclusions'),'audience'=>tyaav_t('nav.audience'),'engagement'=>tyaav_t('nav.engagement'),'system'=>tyaav_t('nav.system'),'settings'=>tyaav_t('nav.settings')];
