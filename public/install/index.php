...
<?php endif; ?>
</main></div><?php endif; ?><footer style="padding:20px;text-align:center;color:#64748b;font-size:12px">Tenyen Analytics v0.7.0 — <a href="https://www.10yendama.com/" target="_blank" rel="noopener noreferrer">Powered by 10yendama.com</a> — © <?= date('Y') > 2026 ? '2026–'.date('Y') : '2026' ?> 10yendama.com</footer></div>
<script>
