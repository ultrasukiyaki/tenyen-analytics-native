...
<main class="main"><div class="view-loading" data-view-loading hidden><span class="spinner"></span><span><?= tyaav_h($translator->get('common.loading')) ?></span></div><div class="view-error" data-view-error hidden></div><div class="view-content" data-view-content><?= $initial['html'] ?></div><footer class="product-footer">Tenyen Analytics v0.5.6 — <a href="https://www.10yendama.com/" target="_blank" rel="noopener noreferrer">Powered by 10yendama.com</a> — © <?= date('Y') > 2026 ? '2026–' . date('Y') : '2026' ?> 10yendama.com</footer></main>
</div>
...
<script src="admin-charts.js?v=0.5.6" defer></script><script src="admin-history.js?v=0.5.6" defer></script><script src="admin-app.js?v=0.5.6" defer></script>
</body></html>
