...
$views = [
    ...
    'exclusions' => ['icon'=>'⊘','label'=>$translator->get('nav.exclusions')],
    'lifecycle' => ['icon'=>'⇩','label'=>$translator->get('nav.lifecycle')],
...
<link rel="stylesheet" href="admin-app.css?v=0.8.0"><link rel="stylesheet" href="admin-history.css?v=0.8.0"><link rel="stylesheet" href="admin-sessions.css?v=0.8.0"></head><body>
<div class="app-shell" data-app-shell>
<header class="topbar"><button class="menu-toggle" type="button" data-menu-toggle aria-label="Menu">☰</button><a class="brand" href="?view=dashboard" data-view-link="dashboard"><span class="brand-mark">T</span><span><b>Tenyen Analytics</b><small>v0.8.0</small></span></a><div class="topbar-site"><?= tyaav_h($siteHost) ?></div><div class="topbar-status" data-global-status><?= tyaav_h($translator->get('common.ready')) ?></div><a class="logout-link" href="?logout=1"><?= tyaav_h($translator->get('auth.logout')) ?></a></header>
...
<main class="main"><div class="view-loading" data-view-loading hidden><span class="spinner"></span><span><?= tyaav_h($translator->get('common.loading')) ?></span></div><div class="view-error" data-view-error hidden></div><div class="view-content" data-view-content><?= $initial['html'] ?></div><footer class="product-footer">Tenyen Analytics v0.8.0 — <a href="https://www.10yendama.com/" target="_blank" rel="noopener noreferrer">Powered by 10yendama.com</a> — © <?= date('Y') > 2026 ? '2026–' . date('Y') : '2026' ?> 10yendama.com</footer></main>
</div>
...
<script src="admin-charts.js?v=0.8.0" defer></script><script src="admin-history.js?v=0.8.0" defer></script><script src="admin-sessions.js?v=0.8.0" defer></script><script src="admin-app.js?v=0.8.0" defer></script>
</body></html>
